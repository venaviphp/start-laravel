    ...
    <div class="container">
        <div class="container-fluid">
            <nav class="p-3 navbar navbar-expand-lg navbar-dark bg-dark">
                ...
                <div class="p-3 collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('register') }}">Регистрация</span></a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <form action=" {{ route('logout') }}" method="POST" class="form-inline">
                                @csrf
                                <input type="submit" class="btn btn-danger me-right" value="Выход">
                            </form>
                        </li>
                    </ul>
                </div>
